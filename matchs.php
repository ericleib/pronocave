...
while($match = mysql_fetch_array($r_matchs)){
	...
	echo "<th align='center' style='color:red'>+".$points_user."</th></tr>";
}
?>
</table>
...
<br>
<div class ="texte">
<font color=6600CC>Huitièmes de finale</font> - <font color=009900>Quarts de finale</font> -
 <font color=CC6600>Demi-finales</font> - <font color=993399>Finale</font><br><br>
